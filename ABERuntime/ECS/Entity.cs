namespace ABEngine.ABERuntime.ECS
{
    ...
    public struct Entity : IEquatable<Entity>
    {
        ...
        public Transform transform
        {
            get
            {
                if(TryGet<Transform>(out Transform trans))
                    return trans;
                else
                {
        ...
        /// <summary>
        /// Tells if this entity is enabled
        /// </summary>
        public bool enabled
        {
            get { return transform.enabled; }
            set
            {
        ...
        {
            Entities.All[index].world_info?.StructureEvents.Disable(this);
        }

        private void Enable()
        {
            Entities.All[index].world_info?.StructureEvents.Enable(this);
        }
