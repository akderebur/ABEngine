...
namespace Halak
{
    public struct JsonArrayBuilder : IDisposable
    {
        ...
        public JsonArrayBuilder Push(Vector2 value)
        {
            JsonObjectBuilder vecObj = new JsonObjectBuilder(100);
            vecObj.Put("X", value.X);
            vecObj.Put("Y", value.Y);
            return Push(vecObj.Build());
        }

        public JsonArrayBuilder Push(Vector3 value)
        {
            JsonObjectBuilder vecObj = new JsonObjectBuilder(150);
            vecObj.Put("X", value.X);
            vecObj.Put("Y", value.Y);
